    ...
    <div class="container">
        ...
        <div id="dashboard_counters">
            ...
            <div class="col-3 mb-3">
                <div class="shipments shipments-created" data-shipments="{{sprintf("%02d", $dashboard['count_parcels_created'])}}">
                    <h6>Created</h6>
                    <h4>00</h4>
                </div>
            </div>
            ...
            <div class="col-3 mb-3">
                <div class="shipments shipments-picked" data-shipments="{{sprintf("%02d", $dashboard['count_parcels_picked'])}}">
                    <h6>Picked</h6>
                    <h4>00</h4>
                </div>
            </div>
            ...
            <div class="col-3 mb-3">
                <div class="shipments shipments-dip" data-shipments="{{sprintf("%02d", $dashboard['count_parcels_delivery_in_process'])}}">
            ...
            <div class="col-3 mb-3">
                <div class="shipments shipments-dpip" data-shipments="{{sprintf("%02d", $dashboard['count_parcels_delivered_payment_in_process'])}}">
                    <h6>Delivered, Payment In Process</h6>
                    <h4>00</h4>
                </div>
            </div>

            <div class="col-3 mb-3">
                <div class="shipments shipments-dd" data-shipments="{{sprintf("%02d", $dashboard['count_parcels_delivered'])}}">
                    <h6>Delivered</h6>
                    <h4>00</h4>
                </div>
            </div>
            ...
            <div class="col-3 mb-3">
                <div class="shipments shipments-ud" data-shipments="{{sprintf("%02d", $dashboard['count_parcels_undelivered'])}}">
                    <h6>Undelivered</h6>
                    <h4>00</h4>
                </div>
            </div>
            ...
            <div class="col-3 mb-3">
                <div class="shipments shipments-ra" data-shipments="{{sprintf("%02d", $dashboard['count_parcels_reattempt'])}}">
                    <h6>Reattempt</h6>
                    <h4>00</h4>
                </div>
            </div>
            ...
            <div class="col-3 mb-3">
                <div class="shipments shipments-rip" data-shipments="{{sprintf("%02d", $dashboard['count_parcels_return_in_process'])}}">
            ...
            <div class="col-3 mb-3">
                <div class="shipments shipments-rd" data-shipments="{{sprintf("%02d", $dashboard['count_parcels_returned'])}}">
                    <h6>Returned</h6>
                    <h4>00</h4>
                </div>
            </div>
